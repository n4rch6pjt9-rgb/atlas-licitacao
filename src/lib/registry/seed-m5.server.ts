...
const PCP_API = "https://apipcp.portaldecompraspublicas.com.br";
const PCP_PORTAL = "https://www.portaldecompraspublicas.com.br";
const PCP_DISCOVER = "/publico/listarProcessos/";
...
const PCP_ENTES: PcpEnte[] = [
  ...
  },
  {
    ...
    excerpt:
      "O Pregão ocorrerá em sessão pública exclusivamente em ambiente eletrônico, na Internet, no endereço eletrônico: www.portaldecompraspublicas.com.br.",
  ...
  },
  {
    ...
    excerpt:
      "via Sistema Eletrônico de Administração de Compras, através do site www.portaldecompraspublicas.com.br",
...
const ASSESSMENTS: Assessment[] = [
  {
    ...
    uncaptured_volume: 0.88,
    public_access_score: 0.7,
  ...
  },
  {
    ...
    uncaptured_volume: 0.35,
    public_access_score: 0.95,
  ...
  },
  {
    ...
    integration_cost: 0.85,
    maintenance_risk: 0.8,
    uncaptured_volume: 0.55,
    public_access_score: 0.4,
    source_reliability: 0.4,
    evidence_confidence: 1,
    historical_depth: 0.3,
    technical_reuse: 0.15,
  ...
  },
  {
    ...
    adapter_fit: "GENERIC_ACTION_FIT",
    integration_cost: 0.7,
    maintenance_risk: 0.55,
    uncaptured_volume: 0.45,
    public_access_score: 0.7,
    source_reliability: 0.7,
    evidence_confidence: 0.4,
    historical_depth: 0.25,
    technical_reuse: 0.45,
    estimated_records_month: null,
  ...
  },
  {
    ...
    uncaptured_volume: 0.7,
    public_access_score: 0.2,
  ...
  },
  {
    ...
    uncaptured_volume: 0.4,
    public_access_score: 0.1,
    source_reliability: 0.15,
    evidence_confidence: 1,
    historical_depth: 0.15,
    technical_reuse: 0.05,
    estimated_records_month: null,
...
const MUNICIPALITY_BASE: Array<{
  ...
  { ibge: "3530606", uf: "SP", name: "Mogi das Cruzes", population: 450000, status: "EXTERNAL_PLATFORM" },
  { ibge: "4213500", uf: "SC", name: "Porto Belo", population: 27000, status: "EXTERNAL_PLATFORM" },
  { ibge: "1718204", uf: "TO", name: "Porto Nacional", population: 53000, status: "EXTERNAL_PLATFORM" },
  { ibge: "3200201", uf: "ES", name: "Alegre", population: 30000, status: "EXTERNAL_PLATFORM" },
  { ibge: "3203205", uf: "ES", name: "Linhares", population: 176000, status: "EXTERNAL_PLATFORM" },
  { ibge: "3550308", uf: "SP", name: "São Paulo", population: 11450000, status: "UNKNOWN" },
  { ibge: "3304557", uf: "RJ", name: "Rio de Janeiro", population: 6211000, status: "UNKNOWN" },
  { ibge: "3106200", uf: "MG", name: "Belo Horizonte", population: 2315000, status: "UNKNOWN" },
  { ibge: "2927408", uf: "BA", name: "Salvador", population: 2418000, status: "UNKNOWN" },
  { ibge: "2304400", uf: "CE", name: "Fortaleza", population: 2429000, status: "UNKNOWN" },
  { ibge: "2611606", uf: "PE", name: "Recife", population: 1489000, status: "UNKNOWN" },
  { ibge: "4106902", uf: "PR", name: "Curitiba", population: 1773000, status: "UNKNOWN" },
  { ibge: "4314902", uf: "RS", name: "Porto Alegre", population: 1333000, status: "UNKNOWN" },
  { ibge: "1302603", uf: "AM", name: "Manaus", population: 2063000, status: "UNKNOWN" },
  { ibge: "1501402", uf: "PA", name: "Belém", population: 1303000, status: "UNKNOWN" },
  { ibge: "5208707", uf: "GO", name: "Goiânia", population: 1437000, status: "UNKNOWN" },
  { ibge: "1721000", uf: "TO", name: "Palmas", population: 306000, status: "UNKNOWN" },
  { ibge: "4205407", uf: "SC", name: "Florianópolis", population: 537000, status: "MUNICIPAL_PORTAL" },
  { ibge: "3505708", uf: "SP", name: "Barueri", population: 316000, status: "MUNICIPAL_PORTAL" },
  { ibge: "3504008", uf: "SP", name: "Assis", population: 101000, status: "EXTERNAL_PLATFORM" },
  { ibge: "5300108", uf: "DF", name: "Brasília", population: 2817000, status: "UNKNOWN" },
  { ibge: "2211001", uf: "PI", name: "Teresina", population: 868000, status: "UNKNOWN" },
  { ibge: "2111300", uf: "MA", name: "São Luís", population: 1037000, status: "UNKNOWN" },
  { ibge: "2507507", uf: "PB", name: "João Pessoa", population: 833000, status: "UNKNOWN" },
  { ibge: "2704302", uf: "AL", name: "Maceió", population: 957000, status: "UNKNOWN" },
  { ibge: "2800308", uf: "SE", name: "Aracaju", population: 602000, status: "UNKNOWN" },
  { ibge: "2408102", uf: "RN", name: "Natal", population: 751000, status: "UNKNOWN" },
  { ibge: "5002704", uf: "MS", name: "Campo Grande", population: 898000, status: "UNKNOWN" },
  { ibge: "5103403", uf: "MT", name: "Cuiabá", population: 650000, status: "UNKNOWN" },
  { ibge: "1100205", uf: "RO", name: "Porto Velho", population: 460000, status: "UNKNOWN" },
  { ibge: "1200401", uf: "AC", name: "Rio Branco", population: 364000, status: "UNKNOWN" },
  { ibge: "1600303", uf: "AP", name: "Macapá", population: 442000, status: "UNKNOWN" },
  { ibge: "1400100", uf: "RR", name: "Boa Vista", population: 413000, status: "UNKNOWN" },
];
...
function pcpNotes(ente: PcpEnte): string {
...
async function configurePcpSource(sql: Sql, sourceId: string): Promise<void> {
  await sql.query(
  ...
  await upsertReplace(
    ...
    "source_connector_config",
    {
      ...
      base_url: PCP_API,
      paths_json: { discover: PCP_DISCOVER, responsePath: "dadosLicitacoes" },
...
export async function seedMilestone5(sql: Sql): Promise<void> {
  ...
  for (const ente of PCP_ENTES) {
    ...
    await upsert(sql, "source_system", {
      ...
      slug: ente.slug,
      base_url: PCP_PORTAL,
      technology_family: "PORTAL_COMPRAS_PUBLICAS" satisfies TechnologyFamily,
      vendor_name: "eCustomize Consultoria em Software",
      product_name: "Portal de Compras Públicas",
      vendor_evidence_level: "VERIFIED" satisfies EvidenceLevel,
      vendor_confidence: 1,
      connector_type: "GENERIC_JSON" satisfies ConnectorType,
      classification_state: "INGESTING",
      discovery_strategy: "PUBLIC_JSON_API",
  ...
  await upsert(sql, "coverage_config", {
    ...
    value_text: PRIORITY_SCORE_VERSION,
  ...
  await upsertReplace(
    ...
    "priority_score_version",
    {
      ...
      formula:
        "weighted_sum(coverage_gap, uncaptured_volume, lead_time, technical_reuse, reliability, evidence, public_access, historical_depth, 1-maintenance_risk, 1-integration_cost)",
      weights_json: PRIORITY_WEIGHTS_V1,
      documented_at: OBSERVED,
      notes:
        "v1 lineariza ganho/custo. Não é lei. Multiplicativo documentado como alternativa. Já integrado reduz uncaptured_volume.",
    },
    "version",
  );
  ...
  await upsertReplace(
    ...
    "coverage_window",
    {
      ...
      metric_version: PRIORITY_SCORE_VERSION,
      notes:
        "Janela de avaliação M5. Overlap BLL 67% é desta coorte, não propriedade eterna. Amostra PCP é piloto de 5 entes, não censo nacional.",
    },
    "id",
  );
  ...
  for (const ente of PCP_ENTES) {
    for (let slot = 0; slot < 6; slot += 1) {
      ...
      const control = ente.cnpj
        ? `${ente.cnpj}-1-${String(recN).padStart(6, "0")}/2026`
        : null;
  ...
  for (const row of MUNICIPALITY_BASE) {
    await upsert(sql, "municipality_base", {
      ibge_code: row.ibge,
      uf: row.uf,
      name: row.name,
  ...
  const probes: Array<Record<string, unknown>> = [
    ...
    },
    {
      ...
      ok: true,
      excerpt:
        "title SCPI - Licitações; comprasedital.dll ExtJS 7.9 + uniGUI + fiorilli.js. GET /data e /app/data.json = 404. Sem JSON público de listagem.",
      error: null,
    ...
    },
    {
      ...
      ok: true,
      excerpt:
        "XHTML ASP.NET; /portal/css/portalcss; kendoUI. Primeiros 12KB da homepage sem tabela 2026. Contrato JSON PENDENTE. Censo vigente = 2 VERIFIED.",
      error: null,
  ...
  for (const probe of probes) {
    await upsert(sql, "source_probe_run", probe);
  }

  for (const assessment of ASSESSMENTS) {
    await upsertReplace(
      sql,
      "family_coverage_metric",
      {
...
export const M5_PCP_ENTE_IDS = PCP_ENTES.map((row) => row.id);
export const M5_WINDOW_ID = WINDOW_ID;
